...
%
% An excellent paper on Kalman filtering at the introductory
% level, without detailing the mathematical underpinnings, is:
% "An Introduction to the Kalman Filter" Greg Welch and Gary
% Bishop, University of North Carolina
