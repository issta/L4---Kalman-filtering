...
figure('Units', 'pixels', ...
    'Position', [100 100 500 375]);
hold on;
plot(xvfiltdiff,t,'.',xvsmoothdiff,t,'.','MarkerSize',15);
hTitle = title('Velocity differences with True values');
hXLabel = xlabel('Time (s)');
hYLabel = ylabel('Easting (m/s)');
hLegend = legend(...
    'True - Filtered',...
    'True - Smoothed',...
    'location','SouthEast');
...
savePath = ['/Users/kevin/SkyDrive/KTH Work/',...
    'Period 4 2014/GNSS/Labs/L4 ',...
    '- Kalman filtering/Figures/'];
print('-depsc2', [savePath 'diffPlotsVelocityX']);
figure('Units', 'pixels', ...
    'Position', [100 100 500 375]);
hold on;
plot(yvfiltdiff,t','.',yvsmoothdiff,t','.','MarkerSize',15);
hTitle = title('Velocity differences with True values');
hXLabel = xlabel('Time (s)');
...
savePath = ['/Users/kevin/SkyDrive/KTH Work/',...
    'Period 4 2014/GNSS/Labs/L4 ',...
    '- Kalman filtering/Figures/'];
print('-depsc2', [savePath 'diffPlotsVelocityY']);
%% Velocity Plot
figure('Units', 'pixels', ...
    'Position', [100 100 500 375]);
hold on;
...
savePath = ['/Users/kevin/SkyDrive/KTH Work/',...
    'Period 4 2014/GNSS/Labs/L4 ',...
    '- Kalman filtering/Figures/'];
print('-depsc2', [savePath 'vDataPlotsTimeX']);